          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <motion.div variants={fadeInUp} custom={3} className="flex flex-wrap gap-4 pt-2 justify-center lg:justify-start">
                <a
                  href="#booking"
                  className={`btn-primary-gradient px-6 py-3 rounded-full font-semibold inline-flex items-center gap-2 text-base ${language === 'bn' ? 'font-bangla' : ''}`}
                >
                ...
                <a
                  href="#services"
                  className={`px-6 py-3 rounded-full font-semibold border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 inline-flex items-center gap-2 text-base ${language === 'bn' ? 'font-bangla' : ''}`}
                >
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className={`text-muted-foreground mt-4 max-w-2xl mx-auto text-base sm:text-lg ${language === 'bn' ? 'font-bangla' : ''}`}>
          ...
          >
            {[
              ...
              <motion.div
                ...
                variants={fadeInUp}
                custom={index}
                className="card-elevated p-6 lg:p-8 hover:shadow-lg transition-all duration-300 group"
              >
                ...
                <p className={`text-muted-foreground leading-relaxed text-base ${language === 'bn' ? 'font-bangla' : ''}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <motion.div
              ...
              variants={staggerContainer}
            >
              <motion.span variants={fadeInUp} className={`text-sm font-semibold text-primary uppercase tracking-wider ${language === 'bn' ? 'font-bangla tracking-normal' : ''}`}>
              ...
              <motion.p variants={fadeInUp} className={`text-lg text-primary font-semibold ${language === 'bn' ? 'font-bangla' : ''}`}>
                {language === 'en' ? doctor.title_en : doctor.title_bn}
              </motion.p>

              <motion.p variants={fadeInUp} className={`text-muted-foreground text-base ${language === 'bn' ? 'font-bangla' : ''}`}>
                {language === 'en' ? doctor.institution_en : doctor.institution_bn}
              </motion.p>

              <motion.p variants={fadeInUp} className={`text-muted-foreground leading-relaxed text-base sm:text-lg ${language === 'bn' ? 'font-bangla' : ''}`}>
              ...
              <motion.a
                variants={fadeInUp}
                href="#locations"
                className={`inline-flex items-center gap-2 btn-primary-gradient px-6 py-3 rounded-full font-semibold text-base ${language === 'bn' ? 'font-bangla' : ''}`}
              >
      ...
      <section className="py-12 md:py-16 bg-background" id="services">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <span className={`text-sm font-semibold text-primary uppercase tracking-wider ${language === 'bn' ? 'font-bangla tracking-normal' : ''}`}>
              {t('Expertise', 'দক্ষতা')}
            </span>
            <h2 className={`text-2xl sm:text-3xl md:text-4xl font-bold mt-3 ${language === 'bn' ? 'font-bangla' : ''}`}>
          ...
          <motion.div
            className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-8"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: '-80px' }}
            variants={staggerContainer}
      ...
      <section className="py-12 md:py-16 bg-secondary/30" id="locations">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className={`text-muted-foreground mt-4 text-base sm:text-lg ${language === 'bn' ? 'font-bangla' : ''}`}>
              ...
              <motion.div variants={fadeInUp} className="card-elevated p-6 sm:p-8 flex flex-col">
                ...
                <div className="space-y-5 flex-1">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className={`font-semibold text-foreground text-base ${language === 'bn' ? 'font-bangla' : ''}`}>
                        {t('Address', 'ঠিকানা')}
                      </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${doctor.contact.phone}`} className="text-primary hover:underline font-medium text-base mt-1 block">
                ...
                <a
                  ...
                  className={`mt-6 w-full btn-primary-gradient px-6 py-3 rounded-full font-semibold inline-flex items-center justify-center gap-2 text-base ${language === 'bn' ? 'font-bangla' : ''}`}
                >
