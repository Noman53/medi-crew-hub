      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className={`text-sm text-background/70 ${language === 'bn' ? 'font-bangla' : ''}`}>
              {t(
          ...
          {/* Quick Links */}
          <div>
            <h4 className={`text-sm font-semibold uppercase tracking-wider mb-4 ${language === 'bn' ? 'font-bangla' : ''}`}>
        ...
        <div className="mt-12 pt-8 border-t border-background/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className={`text-sm text-background/50 ${language === 'bn' ? 'font-bangla' : ''}`}>
              © 2026 {t('Doctor Directory. All rights reserved.', 'ডাক্তার ডিরেক্টরি। সর্বস্বত্ব সংরক্ষিত।')}
            </p>
